<nav id="header" class="fixed w-full z-30 top-0 text-white">
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        <div class="pl-4 flex items-center">
            <a class="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="{{ route('index.home') }}">
                <img src="{{ asset('img/logo.png') }}" alt="Logo" height="50px" width="50px" class="h-8 fill-current inline">
